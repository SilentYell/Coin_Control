  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system", 
          content: "You are a financial advisor helping users understand their spending patterns. Use a friendly tone and provide practical advice. Keep responses under 200 words."
        },
        {
          role: "user",
